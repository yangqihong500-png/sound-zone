 ...
 *
 * 【假设】Demo 阶段为静态目录：打标结果落在 Track.tags（扁平集合），
 * 类别仅用于建域时的分组展示与入参校验，过滤判定仍按标签值匹配。
 * 正式版由自动打标模型输出 (category, value) 二元组（docs/03）。
 */
public final class TagCatalog {
    ...
    public static final Map<String, List<String>> CATALOG = Map.of(
            ...
            "风格", List.of("流行", "摇滚", "电子", "说唱", "民谣", "爵士", "古典", "City Pop", "Lo-Fi", "抖音热曲"),
            "场景", List.of("自习", "健身", "旅行", "通勤", "睡前", "工作", "手工"),
